...
function repo() {
  ...
  for (const f of ["check-spec-sync.mjs", "verdict-lib.mjs", "spec-sync-lib.mjs", "ownership-keys.mjs", "sdd-config.mjs", "lifecycle-lib.mjs", "drift-lib.mjs", "cross-spec-lib.mjs","branch-observation-lib.mjs"])
