...
- **FR-001** (state): WHILE the effective ratchet strength — the stronger of the base ref's and the current `policyRatchetPolicy` — is off, THE SYSTEM SHALL perform no ratchet evaluation and exit zero.
